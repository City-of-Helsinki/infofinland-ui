import { getMenu,getPathsFromContext, getResourceFromContext, getResource} from "next-drupal"

export const getMainMenu = async () => await getMenu('main')
