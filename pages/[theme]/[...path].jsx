...
<span class="normal langversions"><span class="linkarrow"><a href="https://www.oph.fi/fi/koulutus-ja-tutkinnot/tyoelamassa-oppiminen#anchor-oppisopimuskoulutus" target="_blank" onclick="ga('send', 'event', 'Exit Links', 'Click', 'oph.fi');" class="outerlink">linkki</a></span><span class="linkorganisation">Finnish National Agency for Education:</span><br><span class="doctitle">Information on apprenticeship training</span><span class="linklanguages"><a href="https://www.oph.fi/fi/koulutus-ja-tutkinnot/tyoelamassa-oppiminen#anchor-oppisopimuskoulutus" target="_blank" onclick="ga('send', 'event', 'Exit Links', 'Click', 'oph.fi');" class="outerlink">Finnish</a> | <a href="https://www.oph.fi/sv/utbildning-och-examina/larande-i-arbetslivet#anchor-laroavtalsutbildning" target="_blank" onclick="ga('send', 'event', 'Exit Links', 'Click', 'oph.fi');" class="outerlink">Swedish</a></span></span>
<h3>
